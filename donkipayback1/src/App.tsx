...
const partnerCategories = [
  {
    ...
    maxRate: '최대 16.7%',
    stores: [
      { name: '다이마루 백화점', discount: '면세 10% + 5% 할인', payback: '1.7% 페이백' },
      { name: '킨테츠 백화점', discount: '면세 10% + 5% 할인', payback: '1.7% 페이백' },
    ]
  },
  {
    id: 'drug',
    ...
    stores: [
      ...
      { name: '고쿠민', discount: '면세 10% + 8% 할인', payback: '4.5% 페이백' },
      { name: '선드럭', discount: '면세 10% + 7% 할인', payback: '4.5% 페이백' },
      { name: '코스모스', discount: '면세 10% + 9% 할인', payback: '3.5% 페이백' },
      { name: '스기', discount: '면세 10% + 8% 할인', payback: '2% 페이백' },
    ]
  },
  {
    id: 'elec',
    ...
    maxRate: '최대 21.5%',
    stores: [
      { name: '에디온 전자상가', discount: '면세 10% + 7% 할인', payback: '4.5% 페이백' },
      { name: '피크카메라', discount: '면세 10% + 7% 할인', payback: 'X' },
    ]
  }
];
